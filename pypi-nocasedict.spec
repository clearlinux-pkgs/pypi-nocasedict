...
Source0  : https://files.pythonhosted.org/packages/5c/31/13a4c15a0265f8ecb2779e338be7371e28d36a454f7174e6e2bfdb3f1341/nocasedict-2.0.4.tar.gz
...
%prep
%setup -q -n nocasedict-2.0.4
cd %{_builddir}/nocasedict-2.0.4
pushd ..
cp -a nocasedict-2.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724079078
